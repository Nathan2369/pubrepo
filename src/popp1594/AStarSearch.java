 ...
 * This is part of the professors AStar program, but was modified to include adding mineable asteroids as vertices of the Astar path.
...
public class AStarSearch  {
	...
	public static Graph createGraphToGoalWithBeacons(Toroidal2DPhysics state, Ship myShip, 
		...
		// add the mine-able asteroids
		for (Asteroid asteroid : state.getAsteroids())
		{
			if(asteroid.isMineable())
			{
				Vertex astVertex = new Vertex(asteroid.getPosition());
				graph.addVertex(astVertex);
			}
		}
